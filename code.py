...
class Resize:
    ...
    def resized():
        my_pic = Image.open(filepath)
        resized = my_pic.resize((int(my_box1.get()),
                                int(my_box.get())),
    ...
    crop_button.grid(row=13, column=2, sticky='nsew', ipadx=10,
                     ipady=10)
    ...
    global my_button
    my_button = Button(root, text='Enter the width to crop',
                       command=get_width)
    ...
    global my_button2
    my_button2 = Button(root, text='Enter the height to crop',
                        command=get_height)
